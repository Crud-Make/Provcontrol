...
<div class="bg-slate-800/80 border border-slate-700 rounded-xl p-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="date" x-model="data"
                   class="w-full bg-slate-950 border border-slate-600 rounded-lg px-3 py-2 text-slate-100 focus:border-sky-400 focus:outline-none">
        </div>
        <div>
    ...
    <div class="mt-4 flex flex-wrap gap-3">
        <button type="button" @click="calcular()" :disabled="carregando"
                class="bg-sky-600 hover:bg-sky-500 disabled:opacity-50 text-white px-5 py-2 rounded-lg font-medium">
        ...
        <button type="button" x-show="resultado" x-cloak @click="salvarAlteracoes()" :disabled="salvando"
                class="bg-amber-600 hover:bg-amber-500 disabled:opacity-50 text-white px-5 py-2 rounded-lg font-medium">
